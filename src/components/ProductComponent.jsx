...
const products = [
  {
    ...
    description: "Premium quality electronics from leading manufacturers worldwide",
    ...
    <section className="py-20 px-8 bg-gradient-to-b from-gray-50 to-gray-100 text-gray-900">
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto">
            We specialize in the <span className="font-semibold">export</span> and <span className="font-semibold">import</span> of high-quality products across multiple industries, connecting global manufacturers with international markets.
          </p>
        </motion.div>
      </div>
        ...
        {products.map((product, index) => (
          ...
          >
            ...
            <div className="p-6 bg-white">
              <h4 className="text-lg font-medium text-gray-800 mb-3">Featured Products:</h4>
      ...
      >
        <p className="text-gray-700">
          Our dedicated team ensures seamless logistics and quality assurance at every step. Contact us today to discuss your import/export requirements.
        </p>
        <button  className="mt-6 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors duration-300">
          Request a Quote
        </button>
      </motion.div>
    </section>
